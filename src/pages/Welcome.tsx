...
export default function Welcome() {
  ...
  return <div className="welcome-page">
    ...
    <section className="welcome-resources"><div className="page-width" data-reveal><span className="eyebrow">Keep going when you are ready</span><h2>Plans, news, meals, and ward-level progress live together.</h2><div className="resource-link-grid"><Link to="/library#ward-plan"><BookOpen /><b>Emergency plan & news</b><span>Know what to expect</span></Link><Link to="/planner"><ClipboardList /><b>My preparedness</b><span>Supplies, water, and meals</span></Link><Link to="/library#ward-dashboard"><Sparkles /><b>Ward dashboard</b><span>Anonymous progress only</span></Link></div></div></section>
