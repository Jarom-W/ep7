      ...
      <div className="help-content">
        <section id="quick-start" className="help-chapter" data-help-reveal>
          ...
          <ol className="help-step-list">
            <li><span>1</span><div><b>Create your family account.</b><p>Enter a household name, street address, and ward block. You are signed in immediately; registration does not require an email-confirmation trip.</p></div><Link to="/account?mode=signup">Account <ArrowRight /></Link></li>
        ...
        <section id="troubleshooting" className="help-chapter" data-help-reveal>
          ...
          <div className="help-faq">
            ...
            <details><summary>What if my address does not match the map?<CircleHelp /></summary><p>Save the address and correct ward block in My account. Address formatting ignores spaces and punctuation when connecting to a known household. If it still does not match, report it so the directory record can be checked.</p></details>
